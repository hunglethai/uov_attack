...
u = random_vector(F,n)
v = u*(L[0]*P*L[0].inverse())
w = v * L[0]
check_result = []
check  =  True
for i in tqdm(range(m)):
    check_result.append(w*M[i]*w.column())
    if w*M[i]*w.column() != 0:
        check = False
if check == True and w.is_zero() == False: 
    print(w, "\n")
    print(check_result)


"""
matrices_list = L_submatrix[0] # isotropic basis of M0
